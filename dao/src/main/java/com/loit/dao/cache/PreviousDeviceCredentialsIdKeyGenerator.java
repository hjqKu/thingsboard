...
public class PreviousDeviceCredentialsIdKeyGenerator implements KeyGenerator {
    ...
    private static final String NOT_VALID_DEVICE = CacheConstants.DEVICE_CREDENTIALS_CACHE + "_notValidDeviceCredentialsId";
    ...
    public Object generate(Object o, Method method, Object... objects) {
        ...
        if (deviceCredentials.getDeviceId() != null) {
            ...
            if (oldDeviceCredentials != null) {
                return CacheConstants.DEVICE_CREDENTIALS_CACHE + "_" + oldDeviceCredentials.getCredentialsId();
            }
        }
