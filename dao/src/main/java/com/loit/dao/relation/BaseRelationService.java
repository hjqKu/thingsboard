...
import com.loit.common.data.relation.*;
import com.loit.dao.entity.EntityService;
...
import com.loit.common.data.relation.EntityRelationInfo;
...
import static com.loit.common.data.CacheConstants.RELATIONS_CACHE;
...
public class BaseRelationService implements RelationService {
    ...
    @Cacheable(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #to, #relationType, #typeGroup}")
    @Override
    ...
    @Caching(evict = {
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#relation.from, #relation.to, #relation.type, #relation.typeGroup}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#relation.from, #relation.type, #relation.typeGroup, 'FROM'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#relation.from, #relation.typeGroup, 'FROM'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#relation.to, #relation.typeGroup, 'TO'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#relation.to, #relation.type, #relation.typeGroup, 'TO'}")
    })
    @Override
    ...
    @Caching(evict = {
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #to, #relationType, #typeGroup}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #relationType, #typeGroup, 'FROM'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #typeGroup, 'FROM'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#to, #typeGroup, 'TO'}"),
            @CacheEvict(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#to, #relationType, #typeGroup, 'TO'}")
    })
    @Override
    ...
    public ListenableFuture<Void> deleteEntityRelationsAsync(TenantId tenantId, EntityId entityId) {
        Cache cache = cacheManager.getCache(CacheConstants.RELATIONS_CACHE);
    ...
    @Cacheable(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #typeGroup, 'FROM'}")
    @Override
    ...
    @Cacheable(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#from, #relationType, #typeGroup, 'FROM'}")
    @Override
    ...
    @Cacheable(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#to, #typeGroup, 'TO'}")
    @Override
    ...
    @Cacheable(cacheNames = CacheConstants.RELATIONS_CACHE, key = "{#to, #relationType, #typeGroup, 'TO'}")
    @Override
