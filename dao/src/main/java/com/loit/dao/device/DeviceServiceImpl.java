...
import com.loit.common.data.device.DeviceSearchQuery;
...
public class DeviceServiceImpl extends AbstractEntityService implements DeviceService {
    ...
    public Device findDeviceById(TenantId tenantId, DeviceId deviceId) {
        ...
        Validator.validateId(deviceId, INCORRECT_DEVICE_ID + deviceId);
    ...
    @Cacheable(cacheNames = CacheConstants.DEVICE_CACHE, key = "{#tenantId, #name}")
    @Override
    ...
    @CacheEvict(cacheNames = CacheConstants.DEVICE_CACHE, key = "{#device.tenantId, #device.name}")
    @Override
    ...
    public void deleteDevice(TenantId tenantId, DeviceId deviceId) {
        ...
        Cache cache = cacheManager.getCache(CacheConstants.DEVICE_CACHE);
        cache.evict(list);
