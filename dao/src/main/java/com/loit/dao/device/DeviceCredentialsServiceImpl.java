...
import static com.loit.common.data.CacheConstants.DEVICE_CREDENTIALS_CACHE;
import static com.loit.dao.service.Validator.validateId;
import static com.loit.dao.service.Validator.validateString;
...
public class DeviceCredentialsServiceImpl extends AbstractEntityService implements DeviceCredentialsService {
    ...
    @Override
    @Cacheable(cacheNames = CacheConstants.DEVICE_CREDENTIALS_CACHE, key = "'deviceCredentials_' + #credentialsId", unless = "#result == null")
    ...
    @Override
    @CacheEvict(cacheNames = CacheConstants.DEVICE_CREDENTIALS_CACHE, keyGenerator = "previousDeviceCredentialsId", beforeInvocation = true)
    ...
    @Override
    @CacheEvict(cacheNames = CacheConstants.DEVICE_CREDENTIALS_CACHE, key = "'deviceCredentials_' + #deviceCredentials.credentialsId")
