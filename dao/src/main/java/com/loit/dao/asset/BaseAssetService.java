...
import com.loit.common.data.asset.AssetSearchQuery;
...
import com.loit.dao.customer.CustomerDao;
import com.loit.dao.entity.AbstractEntityService;
...
import com.loit.dao.service.DataValidator;
import com.loit.dao.service.PaginatedRemover;
import com.loit.dao.service.Validator;
import com.loit.dao.tenant.TenantDao;
...
import static com.loit.common.data.CacheConstants.ASSET_CACHE;
import static com.loit.dao.DaoUtil.toUUIDs;
import static com.loit.dao.model.ModelConstants.NULL_UUID;
import static com.loit.dao.service.Validator.*;
...
public class BaseAssetService extends AbstractEntityService implements AssetService {
    ...
    @Cacheable(cacheNames = CacheConstants.ASSET_CACHE, key = "{#tenantId, #name}")
    @Override
    ...
    @CacheEvict(cacheNames = CacheConstants.ASSET_CACHE, key = "{#asset.tenantId, #asset.name}")
    @Override
    ...
    public void deleteAsset(TenantId tenantId, AssetId assetId) {
        ...
        Cache cache = cacheManager.getCache(CacheConstants.ASSET_CACHE);
        cache.evict(list);
