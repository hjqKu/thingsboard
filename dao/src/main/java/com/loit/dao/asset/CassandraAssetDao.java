...
import com.loit.dao.model.nosql.AssetEntity;
import com.loit.dao.nosql.CassandraAbstractSearchTextDao;
import com.loit.dao.util.NoSqlDao;
...
import com.loit.common.data.page.TextPageLink;
import com.loit.dao.DaoUtil;
import com.loit.dao.model.EntitySubtypeEntity;
import com.loit.dao.model.nosql.AssetEntity;
import com.loit.dao.nosql.CassandraAbstractSearchTextDao;
import com.loit.dao.util.NoSqlDao;
...
import static com.loit.dao.model.ModelConstants.ASSET_BY_CUSTOMER_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_BY_CUSTOMER_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_BY_TENANT_AND_NAME_VIEW_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_BY_TENANT_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_BY_TENANT_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ASSET_CUSTOMER_ID_PROPERTY;
import static com.loit.dao.model.ModelConstants.ASSET_NAME_PROPERTY;
import static com.loit.dao.model.ModelConstants.ASSET_TENANT_ID_PROPERTY;
import static com.loit.dao.model.ModelConstants.ASSET_TYPE_PROPERTY;
import static com.loit.dao.model.ModelConstants.ENTITY_SUBTYPE_COLUMN_FAMILY_NAME;
import static com.loit.dao.model.ModelConstants.ENTITY_SUBTYPE_ENTITY_TYPE_PROPERTY;
import static com.loit.dao.model.ModelConstants.ENTITY_SUBTYPE_TENANT_ID_PROPERTY;
import static com.loit.dao.model.ModelConstants.ID_PROPERTY;
...
public class CassandraAssetDao extends CassandraAbstractSearchTextDao<AssetEntity, Asset> implements AssetDao {
    ...
    public List<Asset> findAssetsByTenantId(UUID tenantId, TextPageLink pageLink) {
        ...
        List<AssetEntity> assetEntities = findPageWithTextSearch(new TenantId(tenantId), ModelConstants.ASSET_BY_TENANT_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME,
                Collections.singletonList(QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId)), pageLink);
    ...
    public List<Asset> findAssetsByTenantIdAndType(UUID tenantId, String type, TextPageLink pageLink) {
        ...
        List<AssetEntity> assetEntities = findPageWithTextSearch(new TenantId(tenantId), ModelConstants.ASSET_BY_TENANT_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME,
                Arrays.asList(QueryBuilder.eq(ModelConstants.ASSET_TYPE_PROPERTY, type),
                        QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId)), pageLink);
    ...
    public ListenableFuture<List<Asset>> findAssetsByTenantIdAndIdsAsync(UUID tenantId, List<UUID> assetIds) {
        ...
        query.and(QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId));
    ...
    public List<Asset> findAssetsByTenantIdAndCustomerId(UUID tenantId, UUID customerId, TextPageLink pageLink) {
        ...
        List<AssetEntity> assetEntities = findPageWithTextSearch(new TenantId(tenantId), ModelConstants.ASSET_BY_CUSTOMER_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME,
                Arrays.asList(QueryBuilder.eq(ModelConstants.ASSET_CUSTOMER_ID_PROPERTY, customerId),
                        QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId)),
                pageLink);
    ...
    public List<Asset> findAssetsByTenantIdAndCustomerIdAndType(UUID tenantId, UUID customerId, String type, TextPageLink pageLink) {
        ...
        List<AssetEntity> assetEntities = findPageWithTextSearch(new TenantId(tenantId), ModelConstants.ASSET_BY_CUSTOMER_BY_TYPE_AND_SEARCH_TEXT_COLUMN_FAMILY_NAME,
                Arrays.asList(QueryBuilder.eq(ModelConstants.ASSET_TYPE_PROPERTY, type),
                        QueryBuilder.eq(ModelConstants.ASSET_CUSTOMER_ID_PROPERTY, customerId),
                        QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId)),
                pageLink);
    ...
    public ListenableFuture<List<Asset>> findAssetsByTenantIdAndCustomerIdAndIdsAsync(UUID tenantId, UUID customerId, List<UUID> assetIds) {
        ...
        Select.Where query = select.where();
        query.and(QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId));
        query.and(QueryBuilder.eq(ModelConstants.ASSET_CUSTOMER_ID_PROPERTY, customerId));
        query.and(QueryBuilder.in(ModelConstants.ID_PROPERTY, assetIds));
        return findListByStatementAsync(new TenantId(tenantId), query);
    }
    ...
    public Optional<Asset> findAssetsByTenantIdAndName(UUID tenantId, String assetName) {
        ...
        Select.Where query = select.where();
        query.and(QueryBuilder.eq(ModelConstants.ASSET_TENANT_ID_PROPERTY, tenantId));
        query.and(QueryBuilder.eq(ModelConstants.ASSET_NAME_PROPERTY, assetName));
    ...
    public ListenableFuture<List<EntitySubtype>> findTenantAssetTypesAsync(UUID tenantId) {
        ...
        Select.Where query = select.where();
        query.and(QueryBuilder.eq(ModelConstants.ENTITY_SUBTYPE_TENANT_ID_PROPERTY, tenantId));
        query.and(QueryBuilder.eq(ModelConstants.ENTITY_SUBTYPE_ENTITY_TYPE_PROPERTY, EntityType.ASSET));
