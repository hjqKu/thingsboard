...
public class EntitySubtypeEntity {
    ...
    @Column(name = ModelConstants.ENTITY_SUBTYPE_TENANT_ID_PROPERTY)
    private UUID tenantId;

    @PartitionKey(value = 1)
    @Column(name = ModelConstants.ENTITY_SUBTYPE_ENTITY_TYPE_PROPERTY, codec = EntityTypeCodec.class)
    private EntityType entityType;

    @PartitionKey(value = 2)
    @Column(name = ModelConstants.ENTITY_SUBTYPE_TYPE_PROPERTY)
    private String type;
