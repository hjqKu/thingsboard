...
import com.loit.dao.model.nosql.AuditLogEntity;
import com.loit.dao.nosql.CassandraAbstractSearchTimeDao;
import com.loit.dao.timeseries.TsPartitionDate;
...
import static com.loit.dao.model.ModelConstants.AUDIT_LOG_BY_CUSTOMER_ID_CF;
import static com.loit.dao.model.ModelConstants.AUDIT_LOG_BY_ENTITY_ID_CF;
import static com.loit.dao.model.ModelConstants.AUDIT_LOG_BY_TENANT_ID_CF;
import static com.loit.dao.model.ModelConstants.AUDIT_LOG_BY_USER_ID_CF;
import static com.loit.dao.model.ModelConstants.AUDIT_LOG_COLUMN_FAMILY_NAME;
...
public class CassandraAuditLogDao extends CassandraAbstractSearchTimeDao<AuditLogEntity, AuditLog> implements AuditLogDao {
    ...
    public List<AuditLog> findAuditLogsByTenantIdAndEntityId(UUID tenantId, EntityId entityId, List<ActionType> actionTypes, TimePageLink pageLink) {
        ...
        List<AuditLogEntity> entities = findPageWithTimeSearch(new TenantId(tenantId), ModelConstants.AUDIT_LOG_BY_ENTITY_ID_CF,
                Arrays.asList(eq(ModelConstants.AUDIT_LOG_TENANT_ID_PROPERTY, tenantId),
                        QueryBuilder.eq(ModelConstants.AUDIT_LOG_ENTITY_TYPE_PROPERTY, entityId.getEntityType()),
    ...
    public List<AuditLog> findAuditLogsByTenantIdAndCustomerId(UUID tenantId, CustomerId customerId, List<ActionType> actionTypes, TimePageLink pageLink) {
        ...
        List<AuditLogEntity> entities = findPageWithTimeSearch(new TenantId(tenantId), ModelConstants.AUDIT_LOG_BY_CUSTOMER_ID_CF,
                Arrays.asList(eq(ModelConstants.AUDIT_LOG_TENANT_ID_PROPERTY, tenantId),
    ...
    public List<AuditLog> findAuditLogsByTenantIdAndUserId(UUID tenantId, UserId userId, List<ActionType> actionTypes, TimePageLink pageLink) {
        ...
        List<AuditLogEntity> entities = findPageWithTimeSearch(new TenantId(tenantId), ModelConstants.AUDIT_LOG_BY_USER_ID_CF,
                Arrays.asList(eq(ModelConstants.AUDIT_LOG_TENANT_ID_PROPERTY, tenantId),
    ...
    private List<AuditLogEntity> fetchSequentiallyWithLimit(AuditLogQueryCursor cursor) {
        if (cursor.isFull() || !cursor.hasNextPartition()) {
            ...
            cursor.addData(findPageWithTimeSearch(new TenantId(cursor.getTenantId()), ModelConstants.AUDIT_LOG_BY_TENANT_ID_CF,
