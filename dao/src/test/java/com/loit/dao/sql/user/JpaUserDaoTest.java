...
import com.loit.dao.AbstractJpaDaoTest;
import com.loit.dao.service.AbstractServiceTest;
import com.loit.dao.user.UserDao;
...
public class JpaUserDaoTest extends AbstractJpaDaoTest {
    ...
    public void testFindByEmail() {
        ...
        Assert.assertEquals("9cb58ba0-27c1-11e7-93ae-92361f002671", user.getId().toString());
        Assert.assertEquals("c97ea14e-27c1-11e7-93ae-92361f002671", user.getTenantId().toString());
        Assert.assertEquals("cdf9c79e-27c1-11e7-93ae-92361f002671", user.getCustomerId().toString());
