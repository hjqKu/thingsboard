...
import com.loit.dao.device.DeviceCredentialsDao;
...
import static com.loit.dao.service.AbstractServiceTest.SYSTEM_TENANT_ID;
...
public class JpaDeviceCredentialsDaoTest extends AbstractJpaDaoTest {
    ...
    public void testFindByDeviceId() {
        ...
        Assert.assertEquals("958e3314-3215-11e7-93ae-92361f002671", deviceCredentials.getId().getId().toString());
    ...
    public void findByCredentialsId() {
        ...
        assertNotNull(deviceCredentials);
        Assert.assertEquals("958e3c74-3215-11e7-93ae-92361f002671", deviceCredentials.getId().getId().toString());
    }
}
