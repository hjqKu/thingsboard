...
import com.loit.actors.ruleChain.RuleChainManagerActor;
...
import com.loit.actors.shared.rulechain.SystemRuleChainManager;
import com.loit.actors.tenant.TenantActor;
    ...
    private void initRuleChainsAndTenantActors() {
        ...
        try {
            ...
            if (systemContext.isTenantComponentsInitEnabled()) {
                PageDataIterable<Tenant> tenantIterator = new PageDataIterable<>(tenantService::findTenants, ContextAwareActor.ENTITY_PACK_LIMIT);
