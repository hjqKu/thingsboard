...
public class RemoteTransportApiService {
    ...
    public void init() {
        ...
        TBKafkaProducerTemplate.TBKafkaProducerTemplateBuilder<TransportProtos.TransportApiResponseMsg> responseBuilder = TBKafkaProducerTemplate.builder();
        ...
        TBKafkaConsumerTemplate.TBKafkaConsumerTemplateBuilder<TransportProtos.TransportApiRequestMsg> requestBuilder = TBKafkaConsumerTemplate.builder();
        ...
        TbKafkaResponseTemplate.TbKafkaResponseTemplateBuilder
                <TransportProtos.TransportApiRequestMsg, TransportProtos.TransportApiResponseMsg> builder = TbKafkaResponseTemplate.builder();
