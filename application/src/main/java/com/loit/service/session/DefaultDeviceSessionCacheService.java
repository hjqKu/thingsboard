 ...
 */
package com.loit.service.session;
...
public class DefaultDeviceSessionCacheService implements DeviceSessionCacheService {
    ...
    @Override
    @Cacheable(cacheNames = CacheConstants.SESSIONS_CACHE, key = "#deviceId.toString()")
    ...
    @Override
    @CachePut(cacheNames = CacheConstants.SESSIONS_CACHE, key = "#deviceId.toString()")
