 ...
 */
package com.loit.common.transport.adaptor;
...
import com.loit.common.msg.kv.AttributesKVMsg;
...
public class JsonConverter {
    ...
    public static TransportProtos.PostAttributeMsg convertToAttributesProto(JsonElement jsonObject) throws JsonSyntaxException {
        if (jsonObject.isJsonObject()) {
            ...
            List<TransportProtos.KeyValueProto> keyValueList = parseProtoValues(jsonObject.getAsJsonObject());
                ...
                if (value.isString()) {
                    ...
                    if (isTypeCastEnabled && NumberUtils.isParsable(value.getAsString())) {
                        try {
                            ...
                            result.add(TransportProtos.KeyValueProto.newBuilder().setKey(valueEntry.getKey()).setType(TransportProtos.KeyValueType.STRING_V)
                    ...
                    result.add(TransportProtos.KeyValueProto.newBuilder().setKey(valueEntry.getKey()).setType(TransportProtos.KeyValueType.BOOLEAN_V)
    ...
    private static TransportProtos.KeyValueProto buildNumericKeyValueProto(JsonPrimitive value, String key) {
        if (value.getAsString().contains(".")) {
            ...
            try {
                ...
                return TransportProtos.KeyValueProto.newBuilder().setKey(key).setType(TransportProtos.KeyValueType.LONG_V)
