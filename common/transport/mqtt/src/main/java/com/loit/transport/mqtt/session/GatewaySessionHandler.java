...
import com.loit.transport.mqtt.MqttTransportContext;
import com.loit.transport.mqtt.MqttTransportHandler;
import com.loit.transport.mqtt.adaptors.JsonMqttAdaptor;
...
import com.loit.common.transport.service.AbstractTransportService;
import com.loit.gen.transport.TransportProtos;
import com.loit.gen.transport.TransportProtos.DeviceInfoProto;
...
public class GatewaySessionHandler {
    ...
    private final TransportProtos.DeviceInfoProto gateway;
    ...
    private ListenableFuture<GatewayDeviceSessionCtx> onDeviceConnect(String deviceName, String deviceType) {
        ...
        if (result == null) {
            transportService.process(TransportProtos.GetOrCreateDeviceFromGatewayRequestMsg.newBuilder()
                    ...
                    new TransportServiceCallback<TransportProtos.GetOrCreateDeviceFromGatewayResponseMsg>() {
                        @Override
                        public void onSuccess(TransportProtos.GetOrCreateDeviceFromGatewayResponseMsg msg) {
